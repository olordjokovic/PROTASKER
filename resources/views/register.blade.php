                    ...
                    <div class="auth-left">
                        <div class="auth-left-content">
                            ...
                            <p class="auth-subtitle">
                                Crea tu cuenta para acceder a ProTasker y gestionar proyectos, tareas y notificaciones.
                            </p>
                            ...
                            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                ...
                                <button class="btn btn-primary w-100 mb-3 btn-main">
                                    Registrarse
                                </button>
                            </form>
                    ...
                    <div class="auth-right">
                        ...
                        <div class="auth-panel">
                            ...
                            <div class="metric-card">
                                ...
                                <p class="metric-value">Usuarios y gestores</p>
                            </div>

                            <div class="metric-card">
                                <div class="metric-label">Seguimiento</div>
