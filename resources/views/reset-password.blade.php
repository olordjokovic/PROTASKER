                    ...
                    <div class="auth-left">
                        <div class="auth-left-content">
                            ...
                            <p class="auth-subtitle">
                                Define una nueva contraseña para recuperar el acceso seguro a tu cuenta de ProTasker.
                            </p>
                    ...
                    <div class="auth-right">
                        ...
                        <div class="auth-panel">
                            ...
                            <div class="metric-card">
                                ...
                                <p class="metric-value">Acceso seguro</p>
                            </div>

                            <div class="metric-card">
                                <div class="metric-label">Cuenta</div>
                                <p class="metric-value">Restablecida</p>
                            </div>
                        </div>
                    </div>
                </div>
